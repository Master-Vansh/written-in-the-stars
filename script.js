...
function previousPage() {
    ...
    if (chapterEnd.classList.contains("hidden") === false) {
...
function showChapterEnd() {
    ...
    if (isLastChapter) {
        ...
        continueBtn.querySelector("span").textContent =
            "BACK TO BEGINNING";

        continueBtn.querySelector("b").textContent =
            "↻";
...
document.addEventListener(
    ...
    (event) => {
        ...
        if (
            readerScreen.classList.contains("hidden")
        ) {
            return;
        }
